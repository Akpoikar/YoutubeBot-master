...
async def play(ctx: commands.Context, *args):
    ...
    with yt_dlp.YoutubeDL({'format': YTDL_FORMAT,
        ...
        try: queues[server_id].append((path, info))
            ...
            connection.play(discord.FFmpegPCMAudio(executable="C:\\Users\\Evil Dreams\\AppData\\Local\\Programs\\Python\\Python310\\Lib\\site-packages\\imageio_ffmpeg\\binaries\\ffmpeg-win64-v4.2.2.exe", source=path), after=lambda error=None, connection=connection, server_id=server_id:
